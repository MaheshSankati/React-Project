    ...
    <div>
      <div className="bg-gray-100 min-h-screen p-5 mt-16">
        ...
        <div
          ...
          style={{ backgroundImage: `url(${service04})` }}
        >
        ...
        <div className="max-w-6xl mx-auto p-6">
          ...
          <p className="text-gray-700 text-lg my-6">
            A automobile wash is a technique that entails an outside and indoors
            cleaning, relying on wherein you’re getting it. An computerized
            drive-via automobile wash doesn’t provide indoors cleaning, which
            incorporates vacuuming the seats and ground and wiping down
            difficult surfaces. Its number one purpose is to cast off salt,
            dirt, tar, and different environmental particles from the coat of
            your vehicles. Some vehiclemobile wash centers provide area of
            expertise coatings, like unique soaps or waxes, to get rid of
            caked-on grime.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center my-8">
            ...
            <div>
              <h2 className="text-2xl font-bold text-gray-800 mb-4">
                What Does Interior Car Wash Involve?
              </h2>
              <p className="text-gray-700 mb-4">
                Basic Interior vehicle wash includes:
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center my-8">
            ...
            <div>
              <h2 className="text-2xl font-bold text-gray-800 mb-4">
                What Does Exterior Car Wash Involve?
              </h2>
              <p className="text-gray-700 mb-4">
                Basic Exterior vehicle wash includes:
              </p>
              <ul className="list-disc list-inside text-gray-700 space-y-2">
